...
from model.model_transformer_random import QueryFormer #模型类（这是脚本要训练的模型）
from model.dataset_schema_random import PlanTreeDataset #把 plan 数据组织成 PyTorch Dataset 的类
...
best_res.to_csv('results/job-full/cost/cost-randomschema-job.csv')